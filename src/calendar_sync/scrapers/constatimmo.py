...
async def login_constatimmo(settings: Settings) -> list[Appointment]:
    ...
    manager = BrowserManager(
        ...
        # Do NOT use persistent context — stale cookies cause 403 Forbidden.
        # Login is fast enough to redo each time.
        user_data_dir=None,
    )
    ...
    try:
        ...
        await page.goto(settings.constatimmo_url, wait_until="domcontentloaded", timeout=30000)
